...
const MessagingWorkspaceDemo: React.FC = () => {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col lg:flex-row overflow-hidden bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100">
      {/* Conversation list */}
      <div
        className={`w-full lg:w-64 border-r border-gray-200 dark:border-gray-700/60 flex flex-col min-h-0 bg-gray-50 dark:bg-gray-900 ${
          mobileView === 'chat' ? 'hidden lg:flex' : 'flex'
        }`}
      >
        <div className="shrink-0 p-3 border-b border-gray-200 dark:border-gray-700/60">
        ...
        <div className="shrink-0 flex items-center justify-between px-3 py-2 border-b border-gray-200 dark:border-gray-700/60">
        ...
        {showNotifications && (
          <div className="shrink-0 border-b border-gray-200 dark:border-gray-700/60 bg-gray-100/80 max-h-40 overflow-y-auto dark:bg-gray-800/80">
            {notifications.map((n) => (
              <button
                key={n.id}
                type="button"
      ...
      {/* Chat panel */}
      <div
        className={`min-h-0 flex-1 flex flex-col min-w-0 bg-white dark:bg-gray-900 ${
          mobileView === 'list' ? 'hidden lg:flex' : 'flex'
        }`}
      >
        <div className="shrink-0 px-4 py-3 border-b border-gray-200 dark:border-gray-700/60 flex items-center gap-3 bg-white dark:bg-gray-900">
          <button
            type="button"
        ...
        <div className="shrink-0 p-3 border-t border-gray-200 dark:border-gray-700/60 bg-white dark:bg-gray-900">
